...
RSpec.describe ExporterController, type: :controller do
  ...
  describe "GET #institutions" do
    ...
    describe "controller" do
      ...
      it "adds locations for institution" do
        require 'nokogiri'

        Nokogiri::XML::Builder.new(:encoding => 'UTF-8') do |xml|

          controller.add_locations_for(xml, Entry.where(institution_id: 1).where(ap_count: 1..Float::INFINITY))

          doc = Nokogiri::XML(xml.to_xml)

          expect(doc.to_s).to have_content("ammattikorkeakoulu")
